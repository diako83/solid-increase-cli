    ...
    <div className="   bg-orange/[.10  ">
      <div className="  p-3 shadow-2xl  ">
        ...
        >
          ...
          >
            <h1 className="text-2xl md:text-4xl font-semibold text-turquoise/[0.90]  text-center mb-2  ">
              {props.workout.title}
            </h1>
            <p className="text-xl md:text-xl font-semibold text-turquoise/[0.90]   text-center mb-2  ">
